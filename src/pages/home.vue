...
.home_one_title_span_slide_in_two {
  ...
  overflow: hidden; /* 隐藏超出容器的内容 */
  white-space: nowrap; /* 防止文本换行 */
  animation: blink 0.2s 1.85s 1, /* 闪烁动画，延迟 2 秒开始，闪烁 2 次 */ slideInRight 0.9s 0.48s forwards; /* 动画效果 */
}
...
.home_one_title_span_slide_in_three {
  ...
  overflow: hidden; /* 隐藏超出容器的内容 */
  white-space: nowrap; /* 防止文本换行 */
  animation: blink 0.15s 1.5s 2, /* 闪烁动画，延迟 2 秒开始，闪烁 2 次 */ slideInRight 0.4s 0.9s forwards; /* 动画效果 */
}
