        ...
        <div class="labeling_three">
            <div class="labeling_three_container">
                ...
                <div class="labeling_last_txt">
                    ...
                    <span style="color: #1ae28e;"> automatic document classification </span> and <span style="color: #1ae28e;">social media NLP classification</span>  for 
...
.labeling_one {
    ...
    align-items: center;
    background-image: url('@/assets/x2/labeling_one.png');
...
.labeling_one_title {
    ...
    font-family: 'Abril';
    font-weight: 700;
    font-size: calc(90px * v-bind(scale));
    color: #1ae28e;
}
.labeling_one_txt {
...
.labeling_two {
    ...
    background-image: url('@/assets/x2/labeling_btm.png');
    background-size: calc(400px * v-bind(scale));
